...
import torch
import glob
#from data.wav_to_numpy import data_list 
...
class audio_dataset(Dataset):
    ...
    def __init__(self,
        ...
        # changed to support saving large ndarray
        self.data = self._make_data_pieces()

    def _make_data_pieces(self):
        data_pieces = []
        pattern = self.audio_path + '*' + '.npy'
